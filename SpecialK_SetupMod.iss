...
// This is needed to rename the backed up executable to the original filename.
...
#if Defined BackupFile
Source: "{app}\{#BackupFile}";                       DestDir: "{app}";          Flags: external skipifsourcedoesntexist uninsneveruninstall; DestName: "{#BackupFile}.bak";
