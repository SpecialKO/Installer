...
* Uses [Inno Setup Dependency Installer](https://github.com/DomGries/InnoDependencyInstaller), licensed under [MIT](https://github.com/DomGries/InnoDependencyInstaller/blob/master/LICENSE.md).
